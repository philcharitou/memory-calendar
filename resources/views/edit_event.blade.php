    ...
    <body>
        ...
        <div class="relative flex items-top justify-center min-h-screen sm:items-center py-4 sm:pt-0">
            <div id="fixed-content" class="relative max-w-6xl mx-auto">
                ...
                <div class="form-card">
                    <form method="POST" action="{{ route('events.update', [$event->id]) }}" class="upload-form" enctype="multipart/form-data">
                        @csrf

                        <label>Event Name</label>
                        <input type="text" name="name" value="{{ $event->name }}" placeholder="Enter Product Name">

                        <label>Location</label>
                        <input type="text" name="location" value="{{ $event->location }}" placeholder="Enter Location">
